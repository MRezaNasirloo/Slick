...
class PresenterCustomView : SlickPresenter<ViewCustomView>() {
    val code: Int = Random().nextInt(100 - 1) + 1

    override fun onViewUp(view: ViewCustomView) {
        super.onViewUp(view)
    ...
    companion object {
        private val TAG = PresenterCustomView::class.java.simpleName
    }
}
