 ...
 */
public class PresenterFragmentDelegateDagger extends SlickPresenter<ViewFragmentDelegateDagger> {
    ...
    @Override
    public void onViewUp(@NonNull ViewFragmentDelegateDagger view) {
